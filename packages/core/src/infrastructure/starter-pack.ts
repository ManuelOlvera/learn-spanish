...
export const STARTER_PACK: readonly Deck[] = [
  ...
  },
  {
    ...
    emoji: "🥦",
    cards: [
      { id: "tomate", spanish: "el tomate", english: "the tomato", emoji: "🍅" },
      { id: "lechuga", spanish: "la lechuga", english: "the lettuce", emoji: "🥬" },
      { id: "cebolla", spanish: "la cebolla", english: "the onion", emoji: "🧅" },
      { id: "pimiento", spanish: "el pimiento", english: "the pepper", emoji: "🫑" },
      { id: "maiz", spanish: "el maíz", english: "the corn", emoji: "🌽" },
      { id: "brocoli", spanish: "el brócoli", english: "the broccoli", emoji: "🥦" },
      { id: "patata", spanish: "la patata", english: "the potato", emoji: "🥔" },
      { id: "pepino", spanish: "el pepino", english: "the cucumber", emoji: "🥒" },
      { id: "berenjena", spanish: "la berenjena", english: "the aubergine", emoji: "🍆" },
      { id: "champinon", spanish: "el champiñón", english: "the mushroom", emoji: "🍄" },
      { id: "ajo", spanish: "el ajo", english: "the garlic", emoji: "🧄" },
      { id: "guisantes", spanish: "los guisantes", english: "the peas", emoji: "🫛" },
    ],
  },
  {
    id: "dulces",
    ...
    cards: [
      ...
      { id: "chocolate", spanish: "el chocolate", english: "the chocolate", emoji: "🍫" },
      ...
      { id: "donut", spanish: "el donut", english: "the doughnut", emoji: "🍩" },
      { id: "flan", spanish: "el flan", english: "the flan", emoji: "🍮" },
      { id: "miel", spanish: "la miel", english: "the honey", emoji: "🍯", question: "¿Es miel?" },
      { id: "magdalena", spanish: "la magdalena", english: "the muffin", emoji: "🧁" },
      { id: "palomitas", spanish: "las palomitas", english: "the popcorn", emoji: "🍿" },
    ],
  },
  {
    id: "platos",
